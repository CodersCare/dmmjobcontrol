...
return [
    'ctrl'        => [
        'title'                    => 'LLL:EXT:dmmjobcontrol/Resources/Private/Language/locallang_db.xml:tx_dmmjobcontrol_category',
        'label'                    => 'name',
        'tstamp'                   => 'tstamp',
        'crdate'                   => 'crdate',
        'cruser_id'                => 'cruser_id',
        ...
        'sortby'                   => 'sorting',
        'iconfile'                 => 'EXT:dmmjobcontrol/Resources/Public/Icons/category.gif',
    ],
    'feInterface' => [
    ...
    "columns"     => [
        ...
        "name"             => [
            "exclude" => 1,
            "label"   => "LLL:EXT:dmmjobcontrol/Resources/Private/Language/locallang_db.xml:tx_dmmjobcontrol_category.name",
            "config"  => [
                "type" => "input",
                "size" => "30",
                "eval" => "required",
